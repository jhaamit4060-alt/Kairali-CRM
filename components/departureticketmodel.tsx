...
function SectionWrapper({
    ...
    theme: { bg: string; border: string; head: string };
    children: ReactNode;
}) {
    return (
        <div
...
interface DepartureFlightModalProps {
    open?: boolean;
    booking?: any;
    guestTrackerData?: any;
    onClose?: () => void;
    onSubmit?: (data: any) => void;
}

export default function DepartureFlightModal({
    open = true,
    booking = null,
    guestTrackerData = null,
    onClose = () => { },
    onSubmit = () => { },
}: DepartureFlightModalProps) {
    const { user } = useAuth();
